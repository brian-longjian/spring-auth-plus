...
import com.springauth.springauthplus.dao.AuthorizationRepository;
import com.springauth.springauthplus.entity.Authorization;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public void remove(OAuth2Authorization authorization) {
        ...
        if (authorizationId != null) {
            this.authorizationRepository.deleteById(authorizationId);
        }
    }
