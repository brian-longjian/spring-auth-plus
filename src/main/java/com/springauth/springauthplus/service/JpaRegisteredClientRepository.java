...
import com.springauth.springauthplus.dao.ClientRepository;
...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
    ...
    public void save(RegisteredClient registeredClient) {
        ...
        Client clientEntity = toEntity(registeredClient);
    ...
    public RegisteredClient findByClientId(String clientId) {
        Assert.hasText(clientId, " cannot be empty");
        if (clientId != null) {
    ...
    private Client toEntity(RegisteredClient registeredClient) {
        ...
        registeredClient.getAuthorizationGrantTypes()
                .forEach(grantType -> authorizationGrantTypes.add(grantType.getValue()));
    ...
    private static AuthorizationGrantType resolveAuthorizationGrantType(String authorizationGrantType) {
        ...
        // other custom authorization grant type
    ...
    private static ClientAuthenticationMethod resolveClientAuthenticationMethod(String clientAuthenticationMethod) {
        ...
        // else are custom client authentication method
